...
import coffee1993.nearchat.adapter.SimpleListDialogAdapter;
import coffee1993.nearchat.dialog.SimpleListDialog;
import coffee1993.nearchat.dialog.SimpleListDialog.onSimpleListItemClickListener;
...
public class LoginActivity extends BaseActivity implements OnClickListener,
    ...
    protected void initViews() {
        ...
        if (mNickname.length() != 0) {
            ...
            mTvExLogintime.setText(DateUtil.getBetweentime(mLastLogintime));
            if ("女".equals(mGender)) {
    ...
    private void initData() {
        if (android.text.TextUtils.isEmpty(mBirthday)) {
            mSelectDate = DateUtil.getDate(DEFAULT_DATA);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.login_btn_changeUser:
                ...
                SessionManager.clearSession(); // 清空Session数据
        ...
        putAsyncTask(new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... params) {
                try {
                    ...
                    SessionManager.setOnlineStateInt(mOnlineStateInt);
