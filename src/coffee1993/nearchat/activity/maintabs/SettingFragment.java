...
import coffee1993.nearchat.activity.AboutActivity;
import coffee1993.nearchat.activity.MainTabActivity;
import coffee1993.nearchat.activity.SettingInfoActivity;
import coffee1993.nearchat.sql.SqlDBManager;
import coffee1993.nearchat.util.FileUtils;
import coffee1993.nearchat.view.SettingSwitchButton;
...
public class SettingFragment extends BaseFragment implements OnClickListener,
    ...
    private SqlDBManager mSqlDBOperate;
    ...
    protected void init() {
        ...
        mSoundSwitchButton.setChecked(NearChatApplication.getSoundFlag());
        mVibrateSwitchButton.setChecked(NearChatApplication.getVibrateFlag());
    }
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        switch (buttonView.getId()) {
            case R.id.checkbox_sound:
                ...
                NearChatApplication.setSoundFlag(!isChecked);
                break;

            case R.id.checkbox_vibration:
                buttonView.setChecked(isChecked);
                NearChatApplication.setVibrateFlag(isChecked);
                break;
