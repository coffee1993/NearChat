...
public class FriendsAdapter extends BaseObjectListAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NearUser people = (NearUser) getItem(position);
        int avatarId = ImageUtils.getImageID(NearUser.AVATAR + people.getAvatar());
        ...
        holder.mHtvTime.setText(DateUtil.getBetweentime(people.getLogintime()));
