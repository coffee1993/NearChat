...
public class MsgEntity extends Entity {
    ...
    public MsgEntity(String paramSenderIMEI, String paramSendTime, String paramMsgContent,
    ...
    public MsgEntity clone() {
        return new MsgEntity(senderIMEI, sendTime, MsgContent, contentType);
    }
