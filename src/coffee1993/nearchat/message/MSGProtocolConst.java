...
public class MSGProtocolConst {
		
	
		public static final String  BROADCATS_IP = "255.255.255.255";
	//Socket
		public static int UDP_SEND_SOCKET = 0x0523; //1315
		public static int UDP_RECEVE_SOCKET = 0x0979;//1314 更换端口
		public static int TCP_SERVER_SOCKET = 0x0627;
		public static int TCP_CLIENT_SOCKET = 0x0729;
		
		public static final int VERSION = 0x001;		// 版本号
		public static final int PORT = 0x0979;			// 端口号
