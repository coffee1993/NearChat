...
import coffee1993.nearchat.adapter.EmoteAdapter;
...
public class EmoteInputView extends LinearLayout implements OnItemClickListener {
    ...
    public void init() {
        ...
        mDefaultAdapter = new EmoteAdapter(getContext(), NearChatApplication.mEmoticons_Zem);
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        String text = null;
        text = NearChatApplication.mEmoticons_Zem.get(arg2);
